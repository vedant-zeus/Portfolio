...
const Navigation: React.FC = () => {
  ...
  return (
    <>
      ...
      >
        <div
          ...
          style={{
            ...
            minWidth: isHovered ? '800px' : '220px',
          }}
        >
          <div className="flex items-center justify-between gap-6">
            ...
            <button
              ...
              className={`font-bold text-xl italic whitespace-nowrap ${
      ...
      {/* Theme Toggle - Fixed Outside (Desktop + Mobile) */}
      <button
        onClick={toggleTheme}
      ...
      <nav className="md:hidden fixed top-0 left-0 right-0 z-40">
        <div
          className={`m-4 backdrop-blur-md rounded-2xl ${
            isDark ? 'bg-gray-900/95' : 'bg-white/95'
          } shadow-lg`}
        >
